KLEI     1 return {
	...
	overrides = {
		...
		day = "nonight", 				-- "default", "longday", "longdusk", "longnight", "noday", "nodusk", "nonight", "onlyday", "onlydusk", "onlynight"
		...
		trees = "always", 				-- "never", "rare", "default", "often", "always"
		flint = "always", 				-- "never", "rare", "default", "often", "always"
		rock = "always", 				-- "never", "rare", "default", "often", "always"
